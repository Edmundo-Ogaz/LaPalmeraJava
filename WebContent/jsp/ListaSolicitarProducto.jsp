...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaSolicitudProducto.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoIngresoInsumo.jsp&titulo=Nuevo Ingreso Insumo&filproducto=<%=filproducto%>','_self')">Nuevo Ingreso Insumo</button>
