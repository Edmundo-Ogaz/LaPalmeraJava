...
<body>
<!--form action = "/prueba/jsp/ControlListaEntregaInsumo.jsp"-->
<form>
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaOrdenFabricacionInformeEntregaInsumo.jsp&titulo=Lista Orden Fabricación&filordenfabricacion=<%=filordenfabricacion%>','_self')">Volver</button>
</form>
</body>
</html>
