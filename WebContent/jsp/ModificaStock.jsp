...
<body>
<form name = formulario action = "/prueba/servlet/ModificaStock" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaStock.jsp&titulo=Listado Stock&filproducto=<%=filproducto%>','_self')">Volver</button>
</form>
</body>
</html>
