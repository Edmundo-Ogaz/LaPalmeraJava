...
<body>
<form name = formulario action = "/prueba/servlet/ModificaTipoCliente" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaTipoCliente.jsp&titulo=Listado TipoCliente&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Volver</button>
