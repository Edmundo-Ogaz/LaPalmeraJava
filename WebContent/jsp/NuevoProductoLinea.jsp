...
<body>
<form name = formulario action = "/prueba/servlet/GrabaProductoLinea" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaProductoLinea.jsp&titulo=Listado Producto por Linea&filproducto=<%=filproducto%>&fillineaproduccion=<%=fillineaproduccion%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilProductoLinea.jsp&titulo=Filtrado Producto por Linea','_self')">Filtro</button>
