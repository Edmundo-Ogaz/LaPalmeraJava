...
<body>
<form name = formulario action = "/prueba/servlet/GrabaCiudad" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaCiudad.jsp&titulo=Listado Ciudad&filciudad=<%=filciudad%>&filregion=<%=filregion%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilCiudad.jsp&titulo=Filtrado Ciudad','_self')">Filtro</button>
