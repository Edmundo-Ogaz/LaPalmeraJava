...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaOrdenFabricacionCapturaProduccion.jsp&titulo=Listado Orden Fabricación&filordenfabricacion=<%=filordenfabricacion%>','_self')">Volver</button>
</form>
</body>
</html>
