...
<body>
<!--form name = formulario action = "/prueba/jsp/ControlListaIngrediente.jsp" onSubmit="return validar(this)" target="_self"-->
<form>
...
<!--button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoIngrediente.jsp&titulo=Nuevo Ingrediente&filproducto=<%--=filproducto--%>&filinsumo=<%--=filinsumo--%>','_self')">Nuevo Ingrediente</button-->
<!--input type=submit name=Enviar value = 'Modificar'-->
<!--input type=submit name=Enviar value = 'Eliminar'-->
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilInformeDeterminarInsumo.jsp&titulo=Filtrado Informe Determinar insumo','_self')">Volver</button>
