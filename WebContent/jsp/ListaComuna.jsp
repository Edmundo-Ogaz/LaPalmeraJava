...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaComuna.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaComuna.jsp&titulo=Nueva Comuna&filcomuna=<%=filcomuna%>&filciudad=<%=filciudad%>','_self')">Nueva Comuna</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilComuna.jsp&titulo=Filtrado Comuna','_self')">Volver</button>
