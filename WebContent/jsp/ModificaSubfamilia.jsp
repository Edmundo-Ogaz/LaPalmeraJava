...
<body>
<form name = formulario action = "/prueba/servlet/ModificaSubfamilia" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaSubfamilia.jsp&titulo=Listado Subfamilia&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>&filfamilia=<%=filfamilia%>','_self')">Volver</button>
