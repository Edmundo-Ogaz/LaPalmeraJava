...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaOtraCaracteristica.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaOtraCaracteristica.jsp&titulo=Nueva OtraCaracteristica&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Nueva OtraCaracteristica</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilOtraCaracteristica.jsp&titulo=Filtrado OtraCaracteristica','_self')">Volver</button>
