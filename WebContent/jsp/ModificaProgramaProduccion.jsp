...
<body>
<form name = formulario action = "/prueba/servlet/ModificaProgramaProduccion" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaProgramaProduccion.jsp&titulo=Listado Programa Producción&filordenfabricacion=<%=filordenfabricacion%>&filfechainicio=<%=filfechainicio%>&filfechatermino=<%=filfechatermino%>&fillineaproduccion=<%=fillineaproduccion%>&filestadoprograma=<%=filestadoprograma%>','_self')">Volver</button>
</form>
</body>
</html>
