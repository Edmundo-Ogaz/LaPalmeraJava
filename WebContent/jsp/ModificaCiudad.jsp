...
<body>
<form name = formulario action = "/prueba/servlet/ModificaCiudad" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaCiudad.jsp&titulo=Listado Ciudad&filciudad=<%=filciudad%>&filregion=<%=filregion%>','_self')">Volver</button>
