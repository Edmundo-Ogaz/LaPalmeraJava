...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaConceptoTecnico.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoConceptoTecnico.jsp&titulo=Nuevo Concepto Tècnico&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Nuevo Concepto Técnico</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilConceptoTecnico.jsp&titulo=Filtrado Concepto Técnico','_self')">Volver</button>
