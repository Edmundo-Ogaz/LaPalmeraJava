...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaCargo.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoCargo.jsp&titulo=Nuevo Cargo&filcargo=<%=filcargo%>','_self')">Nuevo Cargo</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilCargo.jsp&titulo=Filtrado Cargo','_self')">Volver</button>
