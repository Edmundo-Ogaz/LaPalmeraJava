...
<body>
<form name = formulario action = "/prueba/servlet/ModificaFuncionario" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaFuncionario.jsp&titulo=Listado Funcionario&filrut=<%=filrut%>&filnombre=<%=filnombre%>&filapellidopaterno=<%=filapellidopaterno%>&filapellidomaterno=<%=filapellidomaterno%>&filcargo=<%=filcargo%>&filarea=<%=filarea%>','_self')">Volver</button>
