...
<body>
<form name = formulario action = "/prueba/servlet/GrabaSubfamilia" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaSubfamilia.jsp&titulo=Listado Subfamilia&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>&filfamilia=<%=filfamilia%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilComuna.jsp&titulo=Filtrado Comuna','_self')">Filtro</button>
