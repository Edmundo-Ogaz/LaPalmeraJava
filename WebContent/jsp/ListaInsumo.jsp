...
<body>
<form name="formulario" action = "/prueba/jsp/ControlListaInsumo.jsp" onSubmit="return validar()">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoInsumo.jsp&titulo=Nuevo Insumo&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>&filunidadmedida=<%=filunidadmedida%>','_self')">Nuevo Insumo</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilInsumo.jsp&titulo=Filtrado Insumo','_self')">Volver</button>
