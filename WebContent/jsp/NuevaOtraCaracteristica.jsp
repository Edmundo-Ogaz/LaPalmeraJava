...
<form name = formulario action = "/prueba/servlet/GrabaOtraCaracteristica" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaOtraCaracteristica.jsp&titulo=Listado OtraCaracteristica&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilOtraCaracteristica.jsp&titulo=Filtrado OtraCaracteristica','_self')">Filtro</button>
