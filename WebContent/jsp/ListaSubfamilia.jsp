...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaSubfamilia.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaSubfamilia.jsp&titulo=Nueva Subfamilia&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>&filfamilia=<%=filfamilia%>','_self')">Nueva Subfamilia</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilSubfamilia.jsp&titulo=Filtrado Subfamilia','_self')">Volver</button>
