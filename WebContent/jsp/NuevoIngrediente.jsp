...
<form name = formulario action = "/prueba/servlet/GrabaIngrediente" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaIngrediente.jsp&titulo=Listado Ingrediente&filproducto=<%=filproducto%>&filinsumo=<%=filinsumo%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilIngrediente.jsp&titulo=Filtrado Ingrediente','_self')">Volver</button>
