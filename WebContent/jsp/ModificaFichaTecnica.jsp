...
<body>
<form name = formulario action = "/prueba/servlet/ModificaFichaTecnica" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaFichaTecnica.jsp&titulo=Listado Ficha Técnica&filproducto=<%=filproducto%>&filconceptotecnico=<%=filconceptotecnico%>','_self')">Volver</button>
