...
<body>
<form name = formulario action = "/prueba/servlet/GrabaInsumo" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaInsumo.jsp&titulo=Listado Insumo&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>&filunidadmedida=<%=filunidadmedida%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilInsumo.jsp&titulo=Filtrado Insumo','_self')">Filtro</button>
