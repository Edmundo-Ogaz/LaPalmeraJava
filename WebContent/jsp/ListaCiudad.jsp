...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaCiudad.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaCiudad.jsp&titulo=Nueva Ciudad&filciudad=<%=filciudad%>&filregion=<%=filregion%>','_self')">Nueva Ciudad</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilCiudad.jsp&titulo=Filtrado Ciudad','_self')">Volver</button>
