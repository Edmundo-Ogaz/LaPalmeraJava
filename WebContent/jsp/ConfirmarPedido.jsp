...
function recuperaOtroDetallePedido() {
  ...
  if (!allValid) {
	...
	ajax.open( "GET", "/prueba/jsp/CargarOtroDetallePedido.jsp?producto="+valor1+"&cantidadproducto="+valor2, true );
	ajax.send( "" );
...
function recuperaDetallePedido() {
  ...
  if (!allValid) {
	...
	var valor1 = document.formulario.producto.value;
    var valor2 = document.formulario.cantidadproducto.value;
	ajax.open( "GET", "/prueba/jsp/CargarDetallePedido.jsp?producto="+valor1+"&cantidadproducto="+valor2, true );
	ajax.send( "" );
...
function sacaDetallePedidoUltimo() {
	...
	ajax.open( "GET", "/prueba/jsp/SacarDetallePedidoUltimo.jsp?eliminar="+valor1+"&cantidadproducto="+valor2, true );
	ajax.send( "" );
}
...
function sacaDetallePedido() {
	...
	//ajax.open( "GET", "/prueba/jsp/SacarDetallePedido.jsp?cantidaddetallepedido="+valor1+"&cantidadproducto="+valor2, true );
	ajax.open( "GET", "/prueba/jsp/SacarDetallePedido.jsp?eliminar="+valor1+"&largoeliminar="+valor2+"&insumo="+valor3, true );
	ajax.send( "" );
...
<body>
<form name="formulario" action="/prueba/servlet/ModificaPedido" onSubmit="return ValidaEntrada()">
