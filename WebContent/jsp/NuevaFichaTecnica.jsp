...
<body>
<form name = formulario action = "/prueba/servlet/GrabaFichaTecnica" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaFichaTecnica.jsp&titulo=Listado Ficha Técnica&filproducto=<%=filproducto%>&filconceptotecnico=<%=filconceptotecnico%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilFichaTecnica.jsp&titulo=Filtrado Ficha Técnica','_self')">Filtro</button>
