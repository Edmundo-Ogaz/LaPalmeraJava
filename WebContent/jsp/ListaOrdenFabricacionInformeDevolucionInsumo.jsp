...
<body>
<form name="formulario" action = "/prueba/jsp/ControlListaOrdenFabricacionInformeDevolucionInsumo.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilInformeDevolucionInsumo.jsp&titulo=Filtrado Informe Devolución de Insumos','_self')">Volver</button>
