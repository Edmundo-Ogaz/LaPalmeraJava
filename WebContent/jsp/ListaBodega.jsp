...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaBodega.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaBodega.jsp&titulo=Nueva Bodega&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Nueva Bodega</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilBodega.jsp&titulo=Filtrado Bodega','_self')">Volver</button>
