...
<body>
<form name = formulario action = "/prueba/servlet/ModificaBodega" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaBodega.jsp&titulo=Listado Bodega&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Volver</button>
