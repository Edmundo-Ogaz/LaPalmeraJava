...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaStock.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoStock.jsp&titulo=Nuevo Stock&filproducto=<%=filproducto%>','_self')">Nuevo Stock</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilStock.jsp&titulo=Filtrado Stock','_self')">Volver</button>
