...
<body>
<form name = formulario action = "/prueba/servlet/GrabaTipoCliente" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaTipoCliente.jsp&titulo=Listado TipoCliente&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilTipoCliente.jsp&titulo=Filtrado Tipo de Cliente','_self')">Filtro</button>
