...
<head>
   ...
   <script>
	   ...
	   //window.open("http://localhost:8080/prueba/jsp/mail/java.mail","Mail","width=500,heigth=300,scrollbars=NO");
	   //window.open("http://bodeguero.html","Mail","width=900,heigth=500,scrollbars=NO");
	   alert("Hay Mensajes\n Para el Usuario");
	</script>
</head>
<body>
<form name = formulario action = "/prueba/servlet/GrabaServlet" target="_self">
<table border = 0>
<!--tr>
<td>
destinatario
