...
<jsp:useBean id="ingrediente" class="unab.com.Ingrediente" scope="session"/>
<%
...
<body>
<form name = formulario action = "/prueba/servlet/ModificaIngrediente" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaIngrediente.jsp&titulo=Listado Ingrediente&filproducto=<%=filproducto%>&filinsumo=<%=filinsumo%>','_self')">Volver</button>
