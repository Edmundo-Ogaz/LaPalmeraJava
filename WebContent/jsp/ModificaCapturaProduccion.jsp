...
function recuperaFuncionario()
{
  ...
  if (document.formulario.funcionario.value == -1) {
	...
	ajax.open( "GET", "/prueba/jsp/CargarCapturaProduccionFuncionario.jsp?funcionario="+valor1, true );
	ajax.send( "" );
...
function sacaFuncionario()
{
	...
	ajax.open( "GET", "/prueba/jsp/SacarCapturaProduccionFuncionario.jsp?funcionario="+valor1+"&cantidadfuncionario="+valor2, true );
	ajax.send( "" );
}
-->
</script>
...
<form name = formulario action = "/prueba/servlet/GrabaCapturaProduccion" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaCapturaProduccion.jsp&titulo=Listado Captura Producción&seleccion=<%=ordenfabricacion%>&filordenfabricacion=<%=filordenfabricacion%>','_self')">Volver</button>
</form>
</body>
</html>