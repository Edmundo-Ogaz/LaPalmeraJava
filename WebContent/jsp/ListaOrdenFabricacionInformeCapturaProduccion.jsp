...
<body>
<form name="formulario" action = "/prueba/jsp/ControlListaOrdenFabricacionInformeCapturaProduccion.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilInformeCapturaProduccion.jsp&titulo=Filtrado Informe Captura Producción','_self')">Volver</button>
