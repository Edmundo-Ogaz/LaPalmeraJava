...
<body>
<form name = formulario action = "/prueba/servlet/ModificaConceptoTecnico" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaConceptoTecnico.jsp&titulo=Listado ConceptoTecnico&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Volver</button>
