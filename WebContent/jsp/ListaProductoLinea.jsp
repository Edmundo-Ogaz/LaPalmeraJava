...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaProductoLinea.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoProductoLinea.jsp&titulo=Nuevo Producto por Linea&filproducto=<%=filproducto%>&fillineaproduccion=<%=fillineaproduccion%>','_self')">Nuevo Producto por Linea</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilProductoLinea.jsp&titulo=Filtrado Producto Linea','_self')">Volver</button>
