...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaFamilia.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaFamilia.jsp&titulo=Nueva Familia&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Nueva Familia</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilFamilia.jsp&titulo=Filtrado Familia','_self')">Volver</button>
