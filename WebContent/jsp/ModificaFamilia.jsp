...
<body>
<form name = formulario action = "/prueba/servlet/ModificaFamilia" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaFamilia.jsp&titulo=Lista Familia&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Volver</button>
