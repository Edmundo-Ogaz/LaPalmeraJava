...
<body>
<form name="formulario" action = "/prueba/jsp/ControlListaOrdenFabricacionInformeEntregaInsumo.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilInformeEntregaInsumo.jsp&titulo=Filtrado Informe Entrega de Insumos','_self')">Volver</button>
