...
<jsp:useBean id="usuario" class="unab.com.Usuario" scope="session" /><%if (usuario.getUsuario().equals("")){%>
...
<%if (mail.equals("true")){%>
	<script>
	   ...
	   window.open("http://localhost:8080/prueba/jsp/mail/bodeguero.mail","Mail","scrollbars=1,heigth=300,width=320");
	</script>
<%}%>
