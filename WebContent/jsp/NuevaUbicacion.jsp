...
<form name = formulario action = "/prueba/servlet/GrabaUbicacion" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaUbicacion.jsp&titulo=Listado Ubicacion&filproducto=<%=filproducto%>&filbodega=<%=filbodega%>&filtipoproducto=<%=filtipoproducto%>&filfechaingresoinicio=<%=filfechaingresoinicio%>&filfechaingresotermino=<%=filfechaingresotermino%>&filfechavencimientoinicio=<%=filfechavencimientoinicio%>&filfechavencimientotermino=<%=filfechavencimientotermino%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilUbicacion.jsp&titulo=Filtrado Ubicacion','_self')">Filtro</button>
