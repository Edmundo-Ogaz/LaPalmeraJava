...
<body>
<form name = formulario action = "/prueba/servlet/GrabaIngresoInsumo" onSubmit="return validar(this)" target="_self">
...
<!--button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaIngresoInsumo.jsp&titulo=Listado Ingreso Insumo&filproducto=<%--=filproducto--%>','_self')">Lista</button-->
<!--button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilIngresoInsumo.jsp&titulo=Filtrado Ingreso de Insumos','_self')">Filtro</button-->
</form>
</body>
</html>
