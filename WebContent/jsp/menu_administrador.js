...
function mmLoadMenus() {
  if (window.mm_menu_0328002410_0) return;
    ...
    //mm_menu_0328002410_0.addMenuItem("Conceptos&nbsp;Tecnicos","location='UsoSistema.jsp?destino=FilConceptoTecnico.jsp&titulo=Filtrado Concepto Técnico'");
...
//mm_menu_0328002410_1_1.addMenuItem("Confirmacion&nbsp;Pedidos","location='UsoSistema.jsp?destino=ListaConfirmarPedido.jsp&titulo=Pedidos para Confirmar'");
    ...
    //TRANSACCIONES
    //window.mm_menu_0328002410_1 = new Menu("root",149,12,"Verdana, Arial, Helvetica, sans-serif",10,"#ffffff","#ffff00","#337b67","#337b67","left","middle",1,1,1000,0,0,true,true,true,4,true,true);
    ...
    //mm_menu_0328002410_1.addMenuItem("Confirmaci&oacute;n&nbsp;de&nbsp;Pedidos","location='UsoSistema.jsp?destino=ListaConfirmarPedido.jsp&titulo=Pedidos para Confirmar'");
    ...
    //mm_menu_0328002410_1.addMenuItem("Especificar&nbsp;Producci&oacute;n","location='UsoSistema.jsp?destino=FilEspecificarProduccion.jsp&titulo=Filtrado Especificar Producción'");
    ...
    mm_menu_0328002410_1.addMenuItem("Solicitud&nbsp;de&nbsp;Productos","location='ControlUsoSistema.jsp?destino=NuevaSolicitudProducto.jsp&titulo=Nueva Solicitud Producto'");
     ...
     mm_menu_0328002410_1.childMenuIcon="menu_pasteleria/imgenes/arrows.gif";
  ...
  //mm_menu_0328002410_2.addMenuItem("Rendimientos&nbsp;de&nbsp;Producci&oacute;n","location='pagina_consultar_rendimiento.html'");
    ...
    //mm_menu_0328002410_3.addMenuItem("Salida&nbsp;del&nbsp;Sistema","window.open('index.jsp','_parent');");
