...
var checkOK = "0123456789";
  ...
  if (!allValid) {
    alert("Escriba sólo números en el campo \"Código\" de la ubicación.");
    formulario.codigo.focus();
    return (false);
  }    
...
<table background="images/pasteleria_fondo3.3.png" cellpadding="0" cellspacing="0" width="752"  height="582"class="Middle">
	<tr height="1">
		...
		<td valign="top">
			...
			<tr>
			<td valign="top">
			<h1>Mantenedor SubFamilia</h1>
		<form method = "get" name = "registro" onSubmit = "return validar(this)" action = "/la-palmera/servlet/GrabaSubfamilia">
  <table>
    <tr>
      <td width="67">Código:</td>
      <td width="167"><input name = "codigo" type="type" /></td>
    </tr>
    <tr>
      <td>Nombre :</td>
...
<%Enumeration enumRep = vecRep.elements();%>
  ...
  <%while (enumRep.hasMoreElements())
   ...
   <%}%>
    ...
    <tr>
      <td></td>
      <td  align="right"><input name="enviar" value="Enviar" type="submit"></td>
