...
<table background="images/pasteleria_fondo3.3.png" cellpadding="0" cellspacing="0" width="752"  height="582"class="Middle">
  ...
  <table>
   <tr>
    ...
    <tr>
      <td></td>
      <td align="right"><input name="grabarregion" value="Grabar Región" type="submit"></td>
      <td align="right" width="88"><input name="cancelar" value="Cancelar" type="reset"></td>
    </tr>
  </table>
</form>
				</td>
