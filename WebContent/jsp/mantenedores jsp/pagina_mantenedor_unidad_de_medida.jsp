...
var checkOK = "0123456789";
  ...
  if (!allValid) {
    alert("Escriba sólo números en el campo \"Código\" de la unidad de medida.");
    formulario.codigo.focus();
    return (false);
  }    
...
var checkOK = "ABCDEFGHIJKLMNÑOPQRSTUVWXYZÁÉÍÓÚ" + "abcdefghijklmnñopqrstuvwxyzáéíóú ";
  ...
  if (!allValid) {
    alert("Escriba sólo letras en el campo \"Nombre\" de la unidad de medida.");
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<tr>
				<td valign="top">
				<h1>Mantenedor Unidad de Medida</h1>
				<form method = "get" name = "registro" onSubmit = "return validar(this)" action = "/la-palmera/servlet/GrabaUnidadMedida">
  <table>
   <tr>
      <td width="88">Código:</td>
      <td width="218"><input name = "codigo" type="type" /></td>
    </tr>
    <tr>
      <td>Nombre :</td>
      <td><input name = "nombre" type="type" /></td>
    </tr>
    <tr>
    <td></td>
      <td align="right" width="218"><input name="enviar" value="Enviar" type="submit"></td>
      <td align="right" width="122"><input name="cancelar" value="Cancelar" type="reset"></td>
    </tr>
  </table>
</form>
				</td>
