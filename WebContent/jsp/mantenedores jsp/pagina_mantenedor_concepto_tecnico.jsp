...
function validar(formulario) {
  if (formulario.codigo.value.length < 1) {
    alert("Escriba el código del Concepto Técnico.");
...
var checkOK = "0123456789";
  ...
  if (formulario.nombre.value.length < 1) {
    alert("Escriba el nombre del Concepto Técnico.");
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<tr>
				<td valign="top">
				<h1>Mantenedor Concepto Técnico</h1>
				<form method = "get" name = "registro" onSubmit = "return validar(this)" action = "/la-palmera/servlet/GrabaConceptoTecnico">
  <table>
   <tr>
      <td width="70">Código:</td>
      <td width="174"><input name = "codigo" type="type" size="10"/></td>
    </tr>
    <tr>
      <td>Nombre :</td>
    ...
    <tr>
	  ...
	  <table>
	  <tr>
      <td align="right"><input name="grabarconceptotecnico" value="Grabar Concepto Técnico" type="submit"></td>
