	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<tr>
				<td valign="top">
				<h1>Mantenedor Producto</h1>
				<!--form action="custom_error.jsp" method="post"-->
				<form method = "get" name = "registro" onSubmit = "return validar(this)" action = "/la-palmera/servlet/GrabaProducto">
  <table>
	<tr>
	  <td width="116">Código :</td>
      <td width="181"><input name = "codigo" type="type" /></td>
	  </tr>
      <td width="153">Nombre :</td>
	    <td width="238"><input name = "nombre" type="type" /></td>
    </tr>
    <tr>
	<td>
	Familia :
...
<%Enumeration enumRep3 = vecRep3.elements();%>
   <td><SELECT size="1" name="otrascaracteristicas">
...
<td colspan="3">
<TEXTAREA name="preparacion" rows = 5 cols = 60></TEXTAREA>
</td>
</tr> 
<tr>
<td valign="top">Foto</td>
<td>
<TEXTAREA name="foto" rows = 5 cols = 20></TEXTAREA>
</td> 
<td valign="bottom"><input name = "examinar" value="Examinar" type="button" /></td>
    </tr>
	<tr>
	   <td valign="top">Observación</td>
	<td colspan="3"><TEXTAREA name="observacion" rows = 5 cols = 60></TEXTAREA>
	</td>
	</tr>
	<tr>
      <td></td>
