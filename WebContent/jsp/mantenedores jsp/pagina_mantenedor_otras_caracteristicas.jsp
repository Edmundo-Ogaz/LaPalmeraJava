...
function validar(formulario) {
  if (formulario.codigo.value.length < 1) {
    alert("Escriba el código de otras caracteristicas.");
...
var checkOK = "0123456789";
  ...
  if (formulario.nombre.value.length < 1) {
    alert("Escriba el nombre de la otra caracteristicas.");
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<tr>
				<td valign="top">
				<h1>Mantenedor Otras Caracteristicas</h1>
				<form method="get" name = "registro" onSubmit = "return validar(this)" action = "/la-palmera/servlet/GrabaOtraCaracteristica">
  <table>
    <tr>
      <td width="80">Código:</td>
      <td width="197"><input name = "codigo" type="type" size="10"/></td>
    </tr>
    <tr>
      <td>Nombre :</td>
   ...
   <tr>
      <td></td>
      <td align="right"><input name="grabarotrascaracteristicas" value="Grabar Otras Caracteristicas" type="submit"></td>
      <td align="right" width="78"><input name="cancelar" value="Cancelar" type="reset"></td>
    </tr>
  </table>
</form>
				</td>
