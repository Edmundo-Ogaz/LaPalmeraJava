	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<tr>
				<td valign="top">
				<h1>Mantenedor Familia</h1>
				<!--form action="custom_error.jsp" method="post"-->
				<!--form action="/unabv/servlet/GrabaAsigna"-->
				<form method="get" name = "registro" onSubmit = "return validar(this)" action = "/la-palmera/servlet/GrabaFamilia">
  <table>
    <tr>
    ...
    <tr>
     ...
     <tr>
      <td></td>
	  <td align="right"><input name="gragarfamilia" value="Grabar Familia" type="submit"></td>
      <td align="right"><input name="cancelar" value="Cancelar" type="reset"></td>
	</tr>
  </table>
</form>
				</td>
