...
function validar(formulario) {
  if (formulario.codigo.value.length < 1) {
    alert("Escriba el código de la ubicación.");
...
var checkOK = "0123456789";
  ...
  if (!allValid) {
    alert("Escriba sólo números en el campo \"Cantidad\" de la ubicación.");
    formulario.cantidad.focus();
    return (false);
  }  
  return (true);
