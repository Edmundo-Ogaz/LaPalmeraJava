...
<body>
<form name = formulario action = "/prueba/servlet/ModificaCargo" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaCargo.jsp&titulo=Listado Cargo&filcargo=<%=filcargo%>','_self')">Volver</button>
