...
<body>
<form name = formulario action = "/prueba/servlet/ModificaComuna" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaComuna.jsp&titulo=Listado Comuna&filcomuna=<%=filcomuna%>&filciudad=<%=filciudad%>','_self')">Volver</button>
