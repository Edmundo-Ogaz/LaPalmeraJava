...
<body>
<form name = formulario action = "/prueba/servlet/ModificaLineaProduccion" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaLineaProduccion.jsp&titulo=Listado Linea de Produccion&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Volver</button>
