...
function recuperaOtraSolicitudProducto() {
  ...
  if (!allValid) {
	...
	ajax.open( "GET", "/prueba/jsp/CargarSolicitudProducto.jsp?producto="+valor1+"&cantidadproducto="+valor2, true );
	ajax.send( "" );
...
function recuperaSolicitudProducto() {
  ...
  if (!allValid) {
	...
	var valor1 = document.formulario.producto.value;
    var valor2 = document.formulario.cantidadproducto.value;
	ajax.open( "GET", "/prueba/jsp/CargarSolicitudProducto2.jsp?producto="+valor1+"&cantidadproducto="+valor2, true );
	ajax.send( "" );
...
function sacaSolicitudProductoUltimo() {
	...
	var valor2 = document.formulario.cantidadproducto.value;
	ajax.open( "GET", "/prueba/jsp/SacarSolicitudProductoUltimo.jsp?cantidadsolicitudproducto="+valor1+"&cantidadproducto="+valor2, true );
	ajax.send( "" );
}
...
function sacaSolicitudProducto() {
	...
	ajax.open( "GET", "/prueba/jsp/SacarSolicitudProducto.jsp?eliminar="+valor1+"&largoeliminar="+valor2+"&insumo="+valor3, true );
	ajax.send( "" );
...
<body>
<form name="formulario" action="/prueba/servlet/GrabaSolicitudProducto" onSubmit="return ValidaEntrada()">
<!--form name="formulario" action="/prueba/jsp/Fin.jsp" onSubmit="return ValidaEntrada()"-->
...
<!--button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaConfirmarPedido.jsp&titulo=Pedidos para Confirmar','_self')">Volver</button-->
</form>
</body>
</html>
