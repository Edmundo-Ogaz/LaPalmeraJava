...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaProgramaOrdenFabricacion.jsp" onSubmit="return validar(this)" target="_self">
<table border="1">
<tr>
<th>
Selec
...
<%}%>
<!--button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilPedido.jsp&titulo=Filtrado de Pedidos','_self')">Filtro</button-->
