...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaFuncionario.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoFuncionario.jsp&titulo=Nuevo Funcionario&filrut=<%=filrut%>&filnombre=<%=filnombre%>&filapellidopaterno=<%=filapellidopaterno%>&filapellidomaterno=<%=filapellidomaterno%>&filcargo=<%=filcargo%>&filarea=<%=filarea%>','_self')">Nuevo Funcionario</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilFuncionario.jsp&titulo=Filtrado Funcionario','_self')">Volver</button>
</form>
</body>
</html>
