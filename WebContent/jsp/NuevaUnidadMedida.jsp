...
<body>
<form name = formulario action = "/prueba/servlet/GrabaUnidadMedida" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaUnidadMedida.jsp&titulo=Listado Unidad de Medida&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilUnidadMedida.jsp&titulo=Filtrado UnidadMedida','_self')">Filtro</button>
