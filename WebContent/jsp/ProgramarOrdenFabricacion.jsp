...
<body>
<form name = "pedido" action = "/prueba/servlet/GrabaProgramaProduccion" onSubmit="return Validar()" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaProgramaOrdenFabricacion.jsp&titulo=Orden Fabricación para Programar','_self')">Volver</button>
</form>
</body>
</html>
