...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaPedido.jsp&titulo=Listado de Pedidos&filnumeropedido=<%=filnumeropedido%>&filcliente=<%=filcliente%>&filfechainicio=<%=filfechainicio%>&filfechatermino=<%=filfechatermino%>&filestadopedido=<%=filestadopedido%>','_self')">Volver</button>
</form>
</body>
</html>
