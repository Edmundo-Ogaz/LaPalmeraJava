...
<form name = formulario action = "/prueba/servlet/GrabaStock" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaStock.jsp&titulo=Listado Stock&filproducto=<%=filproducto%>','_self')">Lista</button>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilStock.jsp&titulo=Filtrado Stock','_self')">Filtro</button>
