...
<body>
<form name="formulario" action = "/prueba/jsp/ControlListaProgramaProduccion.jsp" onSubmit="return validar(this)" target="_self">
...
<%--}--%>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilInformeOrdenFabricacion.jsp&titulo=Filtrado Informe Orden Fabricación','_self')">Filtro</button>
