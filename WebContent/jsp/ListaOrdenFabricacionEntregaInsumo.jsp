...
<body>
<form name="formulario" action = "/prueba/jsp/ControlListaOrdenFabricacionEntregaInsumo.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilEntregaInsumo.jsp&titulo=Filtrado Entrega de Insumos','_self')">Volver</button>
