...
<%}%>
<%}%>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaSolicitudProducto.jsp&titulo=Nueva Solicitud Producto&filnumeropedido=<%=filnumeropedido%>','_self')">Nueva Solicitud Producto</button>
</form>
</body>
</html>
<%if (mensaje.length() > 0){%>
