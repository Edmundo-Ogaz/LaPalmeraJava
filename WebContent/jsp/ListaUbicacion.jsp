...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaUbicacion.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaUbicacion.jsp&titulo=Nueva Ubicacion&filproducto=<%=filproducto%>&filbodega=<%=filbodega%>&filtipoproducto=<%=filtipoproducto%>&filfechaingresoinicio=<%=filfechaingresoinicio%>&filfechaingresotermino=<%=filfechaingresotermino%>&filfechavencimientoinicio=<%=filfechavencimientoinicio%>&filfechavencimientotermino=<%=filfechavencimientotermino%>','_self')">Nueva Ubicación</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilUbicacion.jsp&titulo=Filtrado Ubicación','_self')">Volver</button>
