...
<body>
<form action = "/prueba/jsp/ControlListaEspecificarProduccion.jsp">
<table border="1">
<tr>
<th>
Selec
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilEspecificarProduccion.jsp&titulo=Filtrado Especificar Producción','_self')">Volver</button>
</form>
</body>
</html>
