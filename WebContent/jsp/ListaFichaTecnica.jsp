...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaFichaTecnica.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaFichaTecnica.jsp&titulo=Nueva FichaTecnica&filproducto=<%=filproducto%>&filconceptotecnico=<%=filconceptotecnico%>','_self')">Nueva Ficha Técnica</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilFichaTecnica.jsp&titulo=Filtrado FichaTecnica','_self')">Volver</button>
