...
<%}%>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilProgramaProduccion.jsp&titulo=Filtrado Programa Producción','_self')">Filtro</button>
