...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaLineaProduccion.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaLineaProduccion.jsp&titulo=Nueva Linea de Produccion&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Nueva Linea de Produccion</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilLineaProduccion.jsp&titulo=Filtrado Linea de Produccion','_self')">Volver</button>
