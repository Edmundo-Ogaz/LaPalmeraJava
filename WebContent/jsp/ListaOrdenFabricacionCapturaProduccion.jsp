...
<body>
<form name="formulario" action = "/prueba/jsp/ControlListaOrdenFabricacionCapturaProduccion.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilCapturaProduccion.jsp&titulo=Filtrado Captura Producción','_self')">Volver</button>
