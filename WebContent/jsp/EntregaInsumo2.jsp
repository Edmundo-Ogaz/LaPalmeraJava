...
function recuperaOtraEntregaInsumo()
{
  ...
  if (!allValid) {
	...
	ajax.open( "GET", "/prueba/jsp/CargarEntregaInsumo3.jsp?insumo="+valor1+"&cantidadinsumo="+valor2+"&cantidadprogramada="+valor3, true );
	ajax.send( "" );
...
function recuperaUbicacionEntregaInsumo() {
  ...
  if (!allValid) {
    ...
    var valor2 = document.formulario.cantidadinsumo.value;
	var valor3 = document.formulario.cantidadprogramada.value;
	ajax.open( "GET", "/prueba/jsp/CargarEntregaInsumo4.jsp?insumo="+valor1+"&cantidadinsumo="+valor2+"&cantidadprogramada="+valor3, true );
	ajax.send( "" );
...
function sacaEntregaInsumo()
{
	...
	var valor2 = document.formulario.cantidadinsumo.value;
	var valor3 = document.formulario.cantidadprogramada.value;
	ajax.open( "GET", "/prueba/jsp/SacarEntregaInsumo2.jsp?cantidadentregainsumo="+valor1+"&cantidadinsumo="+valor2+"&cantidadprogramada="+valor3, true );
	ajax.send( "" );
}
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaEntregaInsumo.jsp&titulo=Lista Entrega de Insumo&filordenfabricacion=<%=filordenfabricacion%>&seleccion=<%=ordenfabricacion%>','_self')">Volver</button>
</form>
</body>
</html>