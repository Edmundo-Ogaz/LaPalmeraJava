...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaProducto.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoProducto.jsp&titulo=Nuevo Producto&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>&filtipoproducto=<%=filtipoproducto%>&filfamilia=<%=filfamilia%>&filsubfamilia=<%=filsubfamilia%>','_self')">Nuevo Producto</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilProducto.jsp&titulo=Filtrado Producto','_self')">Volver</button>
