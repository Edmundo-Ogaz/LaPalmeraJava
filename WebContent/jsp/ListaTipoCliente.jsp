...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaTipoCliente.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevoTipoCliente.jsp&titulo=Nuevo TipoCliente&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Nuevo TipoCliente</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilTipoCliente.jsp&titulo=Filtrado Tipo de Cliente','_self')">Volver</button>
