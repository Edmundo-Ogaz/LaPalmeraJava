...
function recuperaOtraEntregaInsumo()
{
  ...
  if (!allValid) {
	...
	ajax.open( "GET", "/prueba/jsp/CargarEntregaInsumo.jsp?insumo="+valor1+"&cantidadinsumo="+valor2+"&cantidadprogramada="+valor3, true );
	ajax.send( "" );
...
function recuperaUbicacionEntregaInsumo() {
  ...
  if (!allValid) {
    ...
    var valor2 = document.formulario.cantidadinsumo.value;
	var valor3 = document.formulario.cantidadprogramada.value;
	ajax.open( "GET", "/prueba/jsp/CargarEntregaInsumo2.jsp?insumo="+valor1+"&cantidadinsumo="+valor2+"&cantidadprogramada="+valor3, true );
	ajax.send( "" );
...
function sacaEntregaInsumoUltimo()
{
	...
	var valor2 = document.formulario.cantidadinsumo.value;
	var valor3 = document.formulario.cantidadprogramada.value;
	ajax.open( "GET", "/prueba/jsp/SacarEntregaInsumoUltimo.jsp?cantidadentregainsumo="+valor1+"&cantidadinsumo="+valor2+"&cantidadprogramada="+valor3, true );
	ajax.send( "" );
}
  ...
  function recuperaUnidadMedida()
{
	...
	ajax.open( "GET", "/prueba/jsp/CargaUnidadMedida.jsp?insumo="+valor1, true );	
	//ajax.open( "GET", "/prueba/jsp/CargaCodigoProducto.jsp?subfamiliaSel="+document.formulario.subfamilia.options[document.formulario.subfamilia.selectedIndex].value, true );	
	ajax.send( "" );
}
...
function sacaEntregaInsumo() {
	...
	ajax.open( "GET", "/prueba/jsp/SacarEntregaInsumo.jsp?eliminar="+valor1+"&largoeliminar="+valor2+"&ubicacioninsumo="+valor3, true );
	ajax.send( "" );
...
<form name = formulario action = "/prueba/servlet/GrabaEntregaInsumo" onSubmit="return validar(this)" target="_self">
<!--form name = formulario action = "/prueba/jsp/Fin.jsp" onSubmit="return validar(this)" target="_self"-->
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaEntregaInsumo.jsp&titulo=Lista Entrega de Insumos&filordenfabricacion=<%=filordenfabricacion%>&seleccion=<%=ordenfabricacion%>&mensaje=','_self')">Volver</button>
</form>
</body>
</html>