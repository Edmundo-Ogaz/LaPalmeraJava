...
<body>
<form name = formulario action = "/prueba/servlet/ModificaInsumo" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaInsumo.jsp&titulo=Listado Insumo&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>&filunidadmedida=<%=filunidadmedida%>','_self')">Volver</button>
