...
<body>
<form name = formulario action = "/prueba/servlet/ModificaArea" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaArea.jsp&titulo=Listado Area&filarea=<%=filarea%>','_self')">Volver</button>
