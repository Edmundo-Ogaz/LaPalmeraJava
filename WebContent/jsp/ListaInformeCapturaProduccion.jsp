...
<body>
<!-form name="formulario" action = "/prueba/jsp/ControlListaCapturaProduccion.jsp" onSubmit="return validar(this)" target="_self"-->
<!--form action = "/prueba/jsp/ControlListaCapturaProduccion.jsp"-->
<form>
...
<!--button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=CapturaProduccion.jsp&titulo=Nueva Captura Producción&filordenfabricacion=<%=filordenfabricacion%>&ordenfabricacion=<%=ordenfabricacion%>','_self')">Nueva Captura Producción</button-->
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaOrdenFabricacionInformeCapturaProduccion.jsp&titulo=Listado Orden Fabricación&filordenfabricacion=<%=filordenfabricacion%>','_self')">Volver</button>
</form>
</body>
</html>
