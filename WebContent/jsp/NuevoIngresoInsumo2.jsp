...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=ListaIngresoInsumo.jsp&titulo=Listado IngresoInsumo&filproducto=<%=filproducto%>','_self')">Lista</button>
