...
<body>
<form name = formulario action = "/prueba/jsp/ControlListaUnidadMedida.jsp" onSubmit="return validar()">
...
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=NuevaUnidadMedida.jsp&titulo=Nueva Unidad de Medida&filcodigo=<%=filcodigo%>&filnombre=<%=filnombre%>','_self')">Nueva Unidad de Medida</button>
<input type=submit name=Enviar value = 'Modificar'>
<input type=submit name=Enviar value = 'Eliminar'>
<button type="button" onClick="window.open('/prueba/jsp/UsoSistema.jsp?destino=FilUnidadMedida.jsp&titulo=Filtrado Unidad de Medida','_self')">Volver</button>
