...
public class GrabaCapturaProduccion extends HttpServlet
{
        ...
        throws IOException, ServletException
    {
	    ...
	    { 
	    enviara = "http://localhost:8080/prueba/jsp/UsoSistema.jsp?destino=ListaCapturaProduccion.jsp&titulo=Listado Captura Producci�n";
        ...
        ProduccionFuncionario produccionFuncionario = new ProduccionFuncionario();
