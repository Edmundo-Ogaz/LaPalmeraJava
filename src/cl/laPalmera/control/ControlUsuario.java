...
public class ControlUsuario extends HttpServlet {
    ...
    throws IOException, ServletException {
    	...
    	/*if (sesion.isNew()) {
    	    ...
    	    enviara= "http://localhost:8080/prueba/jsp/Invalido.jsp";
    	    ...
    	    {
    	        if (usuario.getUsuario().equals("bodeguero")) {
				    Mail mail = new Mail();
				...
				enviara = "http://localhost:8080/prueba/jsp/pagina_inicio.jsp?mail="+correo;
