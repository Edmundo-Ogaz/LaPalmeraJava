...
public class OtraCaracteristica {
   ...
   public void grabar() {
      ...
      try {
         ...
         if (var4 != null) {
            ...
            String var6 = "insert into otracaracteristica values (";
            var6 = var6 + "'" + this.codigoOtraCaracteristica + "',";
            var6 = var6 + "'" + this.nombreOtraCaracteristica + "')";
   ...
   public void modificar() {
      ...
      try {
         ...
         if (var4 != null) {
            Statement var5 = var4.createStatement();
            String var6 = "update otracaracteristica set ";
            var6 = var6 + "codigootracaracteristica = " + "'" + this.codigoOtraCaracteristica + "', ";
            var6 = var6 + "nombreotracaracteristica = " + "'" + this.nombreOtraCaracteristica + "' where codigootracaracteristica = '" + this.codigoOtraCaracteristica + "'";
   ...
   public void eliminar() {
      ...
      try {
         ...
         if (var4 != null) {
            Statement var5 = var4.createStatement();
            String var6 = "delete from otracaracteristica where ";
            var6 = var6 + "codigootracaracteristica = '" + this.codigoOtraCaracteristica + "'";
            System.out.println(var6);
            int var7 = var5.executeUpdate(var6);
            if (var7 == 1) {
   ...
   public boolean buscar() {
      ...
      try {
         ...
         if (var5 != null) {
            ...
            String var7 = "select * from otracaracteristica where codigootracaracteristica = '" + this.codigoOtraCaracteristica + "'";
            System.out.println(var7);
            ResultSet var8 = var6.executeQuery(var7);
            if (var8.next()) {
               System.out.println("Lo encontro");
               this.codigoOtraCaracteristica = var8.getString(1);
               this.nombreOtraCaracteristica = var8.getString(2);
               var1 = true;
            }
